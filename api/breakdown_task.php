<?php
/**
 * API Endpoint for the "Task Breakdown" feature.
 *
 * This script receives a complex task from the user, sends it to the
 * Google Gemini API with a specific prompt to break it down into smaller steps,
 * and returns the generated steps as a JSON response.
 */
