<?php
/**
 * API Endpoint for the "Formalizer" feature.
 *
 * This script receives a piece of text and a desired formality level from the user,
 * sends it to the Google Gemini API with a specific prompt to rephrase the text,
