<?php
/**
 * API Endpoint for the "Tone Analysis" feature.
 *
 * This script receives a piece of text from the user, sends it to the
 * Google Gemini API with a specific prompt to analyze its tone, and returns
 * the analysis as a JSON response.
 */
