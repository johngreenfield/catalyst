<?php
/**
 * API Endpoint for the "Meal Muse" feature.
 *
 * This script receives a list of ingredients from the user, sends it to the
 * Google Gemini API with a specific prompt to generate a recipe, and returns
 * the generated recipe text as a JSON response.
 */
